...
} elseif ($_instance->childHasBeenRendered('vhH6Jox')) {
    $componentId = $_instance->getRenderedChildComponentId('vhH6Jox');
    $componentTag = $_instance->getRenderedChildComponentTagName('vhH6Jox');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vhH6Jox');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('vhH6Jox', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\wiran\Documents\SEMESTER 4\anakhebat\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>