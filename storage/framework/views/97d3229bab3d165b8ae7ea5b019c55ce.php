...
} elseif ($_instance->childHasBeenRendered('pwpUlGq')) {
    $componentId = $_instance->getRenderedChildComponentId('pwpUlGq');
    $componentTag = $_instance->getRenderedChildComponentTagName('pwpUlGq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pwpUlGq');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('pwpUlGq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('COCoyEX')) {
    $componentId = $_instance->getRenderedChildComponentId('COCoyEX');
    $componentTag = $_instance->getRenderedChildComponentTagName('COCoyEX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('COCoyEX');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('COCoyEX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\Users\wiran\Desktop\anakhebat\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>